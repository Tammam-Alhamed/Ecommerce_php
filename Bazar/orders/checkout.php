...
$ordersprice_d = filterRequest("ordersprice_d");
...
$totalprice_d = $ordersprice_d  + $pricedelivery;
...
if ($checkcoupon  > 0) {
    ...
    $totalprice_d =  $totalprice_d - $ordersprice_d * $coupondiscount / 100;
...
$data = array(
    ...
    "orders_price_d"  =>  $ordersprice_d,
    "orders_coupon"  =>  $couponid,
    "orders_totalprice"  =>  $totalprice,
    "orders_totalprice_d"  =>  $totalprice_d,
